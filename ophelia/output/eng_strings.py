...
command_error_member_not_found = "Could not find member. (This command is case-sensitive!)"
command_error_user_not_found = "Could not find user. (This command is case-sensitive!)"
...
reactrole_dm_timeout_desc = "Cancelling role assignment operation."
...
voicerooms_log_add = "**{name}** ({id}) **added {target}** ({target_id}) **to {room}**\n_ _"
voicerooms_log_remove = "**{name}** ({id}) **removed {target}** ({target_id}) **from {room}**\n_ _"
voicerooms_log_blacklist = "**{name}** ({id}) **blacklisted {target}** ({target_id}) **in {room}**\n_ _"
voicerooms_log_unblacklist = "**{name}** ({id}) **blacklisted {target}** ({target_id}) **in {room}**\n_ _"
voicerooms_log_mute = "**{name}** ({id}) **muted {target}** ({target_id}) **in {room}**\n_ _"
voicerooms_log_unmute = "**{name}** ({id}) **unmuted {target}** ({target_id}) **in {room}**\n_ _"
voicerooms_log_rename = "**{name}** ({id}) **changed room name from** `{prev}` **to** `{curr}`\n_ _"
voicerooms_log_resize = "**{name}** ({id}) **changed room size from {prev} to {curr}**\n_ _"
voicerooms_log_bitrate = "**{name}** ({id}) **changed room bitrate from {prev}kbps to {curr}kbps**\n_ _"
voicerooms_log_transfer = "**{name}** ({id}) **transfered room to {new_name}** ({new_id})\n_ _"
...
voicerooms_private_title = "Set room to Private (Whitelist Mode)."
voicerooms_private_desc = "Use `%PREFIX%vc add` and `%PREFIX%vc remove` to edit the whitelist."
...
voicerooms_add_desc = "{} added to whitelist."
voicerooms_remove_title = "Removed from room:"
voicerooms_remove_desc = "{} kicked and removed from whitelist."
voicerooms_remove_self_title = "Invalid user!"
voicerooms_remove_self_desc = "You can't kick or blacklist yourself."
voicerooms_remove_mod_title = "Nope"
voicerooms_remove_mod_desc = "You can't remove mod roles from the whitelist!"

voicerooms_blacklist_title = "Blacklisted:"
voicerooms_blacklist_desc = "{} blacklisted. You may remove them from the blacklist using the `%PREFIX%unblacklist` command."
voicerooms_unblacklist_title = "Unblacklisted:"
voicerooms_unblacklist_desc = "{} has been removed from the blacklist."
...
voicerooms_mute_too_long_title = "Invalid Mute Time!"
voicerooms_mute_too_long_desc = "Joinmute time should be under {} seconds."
voicerooms_joinmute_title = "Set room to (Temporary) Joinmute Mode"
voicerooms_joinmute_desc = "All members will be muted for {} seconds upon entering this room."
voicerooms_permmute_title = "Set room to (Permanent) Joinmute Mode"
voicerooms_permmute_desc = "All members will be muted upon entering this room until you unmute them."
...
voicerooms_mute_not_present_title = "Invalid mute target!"
voicerooms_mute_not_present_desc = "You can't mute someone who's not in the room!"
voicerooms_mute_title = "Member muted"
voicerooms_mute_desc = "Muted {}. You may use the `%PREFIX unmute` command to unmute the user."
voicerooms_unmute_self_title = "Invalid unmute target!"
voicerooms_unmute_self_desc = "You can't unmute yourself!"
voicerooms_unmute_not_present_title = "Invalid unmute target!"
voicerooms_unmute_not_present_desc = "You can't unmute someone who's not in the room!"
voicerooms_ununmute_title = "Member ununmuted"
voicerooms_unmute_desc = "Unmuted {}. You may use the `%PREFIX mute` command to mute the user."
